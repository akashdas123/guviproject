...
background-image: url("data:image/jpeg;base64,");
...
# Title
st.title(':blue[Youtube Data SCRAPPING and QUERYING]')



#Data scrapped and stored in mongodb #


col1, col2 ,col3= st.columns(3)
with col1:
    st.header(':blue[Collect youtube data]')
    st.write (' :green to store [MongoDB] database')
    channel_id = st.text_input(':blue **Enter 11 digit channel_id**')

    Get_data = st.button('collect  data and store')

    session_state = st.session_state
    if 'Get_state' not in session_state:
        session_state['Get_state'] = False

    # Check if the Get_data button is clicked or Get_state is True
    if Get_data or session_state.get('Get_state', False):
        ...
        api_version = 'v3'
        api_key = 'AIzaSyDK-6ORNw-AxLl_gvO90pE4Jm9n8GRxw68'
        ...
        #  MongoDB connection and storing the data #

        # create a client instance of MongoDB
        client = pymongo.MongoClient('mongodb+srv://Akash:1234@cluster0.qb7hbsv.mongodb.net/')
...
#*********************************Stor in mysql***************************************************** #
    ...
    st.write(''':blue['Migrate to MySQL'].''')
    Migrate = st.button('Migrate to MySQL')

    # Define Session state to Migrate to MySQL button

    if 'migrate_sql' not in session_state:
        session_state['migrate_sql'] = False
    if Migrate or session_state.get('migrate_sql', False):
        session_state['migrate_sql'] = True
        ...
        for i in range(1, len(result['Channel_data']) - 1):
            ...
            if comments_access == 'Unavailable' or ('Comment_Id_1' not in comments_access or 'Comment_Id_2' not in comments_access):
                ...
                for j in range(1, 3):
                    Comment_details_tosql = {
                    'Video_Id': result['Channel_data'][f"Video_Id_{i}"]['Video_Id'],
                    'Comment_Id': comments_access[f"Comment_Id_{j}"]['Comment_Id'],
                    'Comment_Text': comments_access[f"Comment_Id_{j}"]['Comment_Text'],
                    'Comment_Author': comments_access[f"Comment_Id_{j}"]['Comment_Author'],
                    'Comment_Published_date': comments_access[f"Comment_Id_{j}"]['Comment_PublishedAt'],
                    }
                    Comment_details_list.append(Comment_details_tosql)
        ...
        # Use pandas to insert the DataFrames data to the SQL
        # Channel data to SQL
        ...
        playlist_df.to_sql('playlist', engine, if_exists='append', index=False,
                           dtype={'Channel_Id': sqlalchemy.types.String(length=225),
                                  'Playlist_Id': sqlalchemy.types.String(length=225)})
...
st.header(':blue[Channels]')

# Check available channel data
Check_channel = st.checkbox('channels currently present')
...
# Check if the playlist table exists
cursor.execute("SHOW TABLES LIKE 'playlist';")
table_exists = cursor.fetchone()

if not table_exists:
    # Create the playlist table
    cursor.execute("CREATE TABLE playlist (Channel_Id VARCHAR(225), Playlist_Id VARCHAR(225), Playlist_Name VARCHAR(100), PRIMARY KEY (Playlist_Id));")
    cursor.execute("ALTER TABLE playlist ADD INDEX idx_playlist_id (Playlist_Id);")

# Check if the video table exists
cursor.execute("SHOW TABLES LIKE 'video';")
table_exists = cursor.fetchone()

if not table_exists:
    # Create the video table
    cursor.execute("CREATE TABLE video (Video_Id INT PRIMARY KEY, Video_Name VARCHAR(100), Playlist_Id VARCHAR(225), FOREIGN KEY (Playlist_Id) REFERENCES playlist(Playlist_Id));")
# Q1
